 ...
 */
class AddOrganisationActivity : BaseActivity(), View.OnClickListener {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == Activity.RESULT_OK
            ...
            try {
                ...
                GlideLoader(this@AddOrganisationActivity).loadOrganisationPicture(
